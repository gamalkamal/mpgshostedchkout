...
<script src="https://test-gateway.mastercard.com/form/version/56/merchant/TESTVIKAS/session.js"></script>
...
<div>MID: <input type="text" id="mid" class="input-field" title="Merchant Number" aria-label="Enter your merchant number" value="TESTVIKAS" tabindex="6"></div>
<div>Amount: <input type="text" id="amount" class="input-field" title="Amount" aria-label="Enter amount" value="1" tabindex="7"></div>
<div>API Password: <input type="text" id="api" class="input-field" title="API Password" aria-label="Enter api password" value="f542f182bcc0bc500b8ad03a11d55f3f" tabindex="8" readonly></div>
...
PaymentSession.configure({
    ...
    callbacks: {
		...
		var payload = {
			...
			//console.log(payload);
		$.post("response.php", payload, function (data, status) {
			console.log(data);
			...
			console.log(jsondata['order.status']);
		});
