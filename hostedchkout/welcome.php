...
<li><label>Payent Gateway URL for Javascript<span class="required">*</span></label><input type="url" name="jsurl" size="80" value="https://test-gateway.mastercard.com/checkout/version/57/checkout.js"></li>
<li><label>Payent Gateway URL for Session<span class="required">*</span></label><input type="url" name="ssurl" size="80" value="https://test-gateway.mastercard.com/api/nvp/version/57"></li>
